...
const ColorlibConnector = styled(StepConnector)(({ theme }) => ({
  ...
  [`&.${stepConnectorClasses.active}`]: {
    [`& .${stepConnectorClasses.line}`]: {
      backgroundImage:
        'linear-gradient(95deg, rgb(106, 15, 220) 0%, rgb(167, 96, 255) 50%, rgb(106, 15, 220) 100%)',
    },
  },
...
const ColorlibStepIconRoot = styled('div')(({ theme, ownerState }) => ({
  ...
  ...(ownerState.active && {
    backgroundImage:
      'linear-gradient(136deg, rgb(106, 15, 220) 0%, rgb(167, 96, 255) 50%, rgb(106, 15, 220) 100%)',
